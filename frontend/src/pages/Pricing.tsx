...
export default function Pricing() {
  usePageMeta({
    ...
    description:
      "Planes desde gratis hasta $20/mes para convertir PDF a Word, Word a PDF con OCR, y editar tus documentos PDF en línea.",
  });
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16">
      ...
      <p className="mt-2 text-center text-slate-600">
        Suscripciones mensuales, cancela cuando quieras.
      </p>
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {plans.map((plan) => (
          <div key={plan.id} className="flex flex-col rounded-xl border border-slate-200 bg-white p-6 text-center">
            ...
            >
              {plan.price_cents === 0 ? "Empezar gratis" : stripeEnabled ? "Suscribirse" : "Próximamente"}
            </button>
          </div>
        ))}
      </div>
